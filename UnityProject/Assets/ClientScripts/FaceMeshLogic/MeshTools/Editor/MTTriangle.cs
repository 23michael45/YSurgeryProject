...
{
	[System.Serializable]
	public class MTTriangle : System.IEquatable<MTTriangle>
	{
		// Triangle indices.
		...
		public MTTriangle(int x, int y, int z)
		{
			this.x = x;
			this.y = y;
			this.z = z;
		 ...
		 * Value-wise equals.
		 */
		public bool Equals(MTTriangle tri)
		{
		...
		{
			return b is MTTriangle && this.Equals( (MTTriangle)b );
		}
	...
	internal static class MTTriangleExt
	{
		public static int IndexOf(this IList<MTTriangle> list, int a, int b, int c)
		{
