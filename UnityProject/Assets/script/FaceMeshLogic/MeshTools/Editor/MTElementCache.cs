...
namespace MeshTools
{
	...
	internal class ElementCache : ScriptableObject
	{
		...
		// Selected edges
		public List<MTEdge> edges 		{ get { return _edges; } }
		
		// Selected faces
		public List<MTTriangle> faces 	{ get { return _faces; } }
		...
		[SerializeField] private List<MTEdge> _edges = new List<MTEdge>();
		[SerializeField] private List<MTTriangle> _faces = new List<MTTriangle>();
		 ...
		 */
		public void SetFaces(IList<MTTriangle> faces)
		{
		 ...
		 */
		public void SetEdges(IList<MTEdge> edges)
		{
			this._faces.Clear();
