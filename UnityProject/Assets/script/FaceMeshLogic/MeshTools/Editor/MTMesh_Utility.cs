...
namespace MeshTools
{
	public static class MTMesh_Utility
	{
#region Duplicate
		...
		//[MenuItem("Tools/MeshTools/Combine Meshes", true, 20)]
		...
		//[MenuItem("Tools/MeshTools/Combine Meshes")]
...
#region Mesh Modify
		 ...
		 */
		public static void TranslateVertices_World(this MTMesh mesh, int[] triangles, Vector3 offset)
		{
		 ...
		 */
		public static void TranslateVertices(this MTMesh mesh, int[] triangles, Vector3 offset)
		{
		 ...
		 */
		public static void SetSharedVertexPosition(this MTMesh mesh, int index, Vector3 position)
		{
		...
		public static void RebuildNormals(MTMesh mesh)
		{
...
#region Special
		...
		public static void RebuildUV2(MTMesh mesh)
		{
		...
		public static void Facetize(MTMesh qmesh)
		{
		 ...
		 */
		public static void RebuildColliders(MTMesh mesh)
		{
		 ...
		 */
		public static bool DeleteTriangles(MTMesh mesh, List<MTTriangle> triangles)
		{
			List<MTTriangle> trianglesToRemove = new List<MTTriangle>(triangles);
		...
		private static void RemoveUnusedVertices(ref Mesh mesh)
		{
			...
			for(int i = 0; i < mesh.subMeshCount; i++)
			{
				...
				for(int n = 0; n < tris.Count; n++)
				{
					int rmv_index = MTUtil.NearestIndexPriorToValue(removed, tris[n]) + 1;
					tris[n] -= rmv_index;
				}
...
#region Create
		...
		public static void MakeFaceSelectionMesh(ref Mesh mesh, Vector3[] vertices)
		{
			...
			for(int i = 0; i < vl; i++)	colors[i] = MTConstant.FaceSelectionColor;
		...
		public static void MakeVertexSelectionMesh(ref Mesh mesh, Vector3[] vertices, Vector3[] selected)
		{
			...
			for(int i = vl; i < v.Length; i++)
			{
				...
				t_col[t+0] = (Color32) Color.red;
				t_col[t+1] = (Color32) Color.red;
				t_col[t+2] = (Color32) Color.red;
				t_col[t+3] = (Color32) Color.red;
