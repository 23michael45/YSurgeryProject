...
#region Normal and Tangents
		...
		public static Vector3 Normal(this MTMesh mesh, MTTriangle tri)
		{
		 ...
		 */
		public static void NormalTangentBitangent(Vector3[] vertices, Vector2[] uv, MTTriangle tri, out Vector3 normal, out Vector3 tangent, out Vector3 bitangent)
		{
			normal = MTMath.Normal(vertices[tri.x], vertices[tri.y], vertices[tri.z]);
